      ...
      <CalendarContainer>
        ...
        <BigCalendar
          ...
          eventPropGetter={(event) => {
            ...
            const color = event.color ? event.color : 'blue';

            // Customize the event title to include start and end times
            const eventTitle = `${event.title} (${formatTime(event.start)} - ${formatTime(event.end)})`;

            return {
              style: { backgroundColor, color },
              title: eventTitle, // Set the customized event title
            };
          }}
        />
